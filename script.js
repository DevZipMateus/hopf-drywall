...
/* =============================================
   6. ANIMAÇÃO DA LINHA SOB O H1 DO HERO
   ============================================= */
...
/* =============================================
   9. TILT 3D NOS CARDS (só desktop)
   ============================================= */
function initCardTilt() {
  if ('ontouchstart' in window) return;

  document.querySelectorAll('.servico-card, .produto-card, .dif-card').forEach(card => {
    card.addEventListener('mouseenter', () => {
      card.style.transition = 'transform 0.12s ease, background 0.3s ease, box-shadow 0.3s ease, border-color 0.3s ease';
    });
    ...
    card.addEventListener('mouseleave', () => {
      card.style.transition = 'transform 0.4s ease, background 0.3s ease, box-shadow 0.3s ease, border-color 0.3s ease';
